...
function SectionFourTab() {
  return (
    <Box p="15px" className="tab-cls">
      <Typography fontWeight="700" color="#131C42">
        Additional Safety Requirements
      </Typography>
      <Typography mt="5px" align="left">
        Site rules
      </Typography>
      <TextField
        id="site_rules"
      ...
      />
      <Typography mt="10px" align="left">
        Issue of permit to work specific tasks - electrical, non-electrical,
        pressure system - detail type and task
      </Typography>
      <TextField
        id="site_rules3"
        name={"Site Rules"}
