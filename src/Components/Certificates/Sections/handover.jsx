...
function Handover() {
  return (
    <Box p="15px" className="tab-cls">
      <Typography fontWeight="600" color="#131C42" align="left">
        Handover/Handback
      </Typography>
      <Box border="1px solid #D8D8D8" padding="10px" mt="20px">
        <Grid container rowSpacing={2} columnSpacing={3} mt="2px">
          <Grid item xs={12} md={6} fontSize="30px" lineHeight="45px">
            <Typography mt="5px" component="div" align="left" fontWeight={700}>
              Handover
            </Typography>
            <Typography mt="10px" align="left">
              I, the authorized person, confirm that the precautions identified
              above are in effect, and the site can be safely handed over.
            </Typography>
          </Grid>
          <Grid item xs={12} md={6}>
            ...
            <Typography mt="10px" align="left">
              I, the contractors representative, confirm that the site is in a
              safe condition and can be safely handed back.
            </Typography>
          </Grid>
